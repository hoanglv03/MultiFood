...
import StackScreenLogin from "../ScreensLogin/StackScreenLogin";
    ...
    <View style={{ flex: 1 }}>
      ...
      style={styles.viewPager} initialPage={0}>
        <View style={styles.page} key="1">
          <Image source={require("../../Image/ImageTutorial1.png")} />
        ...
        <View style={[styles.page,{marginTop:30}]} key="2">
          <Image source={require("../../Image/ImageTutorial2.png")} />
          <Text style={styles.title}>
        ...
        <View style={styles.page} key="3">
          <Image source={require("../../Image/ImageTutorial3.png")} />
          <Text style={styles.title}>
